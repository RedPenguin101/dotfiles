...
(def-doom-theme doom-opera-light
  ...
  ((bg-old        '("#fafafa" nil       nil ))
   ...
   (fg-old     '("#2a2a2a" "#2a2a2a" nil ))
   (fg-alt     '("#454545" "#757575" nil ))

   ;; material colors
   (white         '("#FFFFFF" "#FFFFFF" nil ))
   (black         '("#000000" "#000000" nil ))
   (blue-grey-800 '("#37474F" "#37474F" nil ))
   (blue-grey-200 '("#B0BEC5" "#B0BEC5" nil ))
   (blue-grey-50  '("#ECEFF1" "#ECEFF1" nil ))
   (light-grey    '("#FAFAFA" "#FAFAFA" nil ))
   (amber         '("#FF6F00" "#FF6F00" nil ))
   (purple        '("#673AB7" "#673AB7" nil ))
   (orange        '("#FFAB91" "#FFAB91" nil ))
   ...
   ;; This isn't working, wrong argument types or something. fine for now
   ;;(modeline-bg   (blue-grey-50))
   ;;(modeline-bg-l blue-grey-50)
   ;;(modeline-bg-inactive blue-grey-50)
   ;;(modeline-bg-inactive-l blue-grey-50)
  ...
  (((font-lock-comment-face &override)
   ...
   (mode-line
    :background blue-grey-50 :foreground modeline-fg
