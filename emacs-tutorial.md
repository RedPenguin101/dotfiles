...
You can tell which mode you are in by the cursor: it is a 'line' in
insert mode, and a 'block' in command mode. Most of this document will
be about how to move around and move things around from command mode.
...
respectively. `l` move the screen around the current highlighted
